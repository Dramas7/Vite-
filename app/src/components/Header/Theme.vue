<template>
  <div class="hidden items-center mr-2 h-full before:block before:mx-2 before:w-px before:h-6 before:bg-[#3c3c431f] xl:flex">
    <button class="relative ml-2 w-10 h-[22px] bg-[#f6f6f7] rounded-full border border-[#3c3c434a]">
      <span class="absolute top-px left-px flex justify-center items-center w-[18px] h-[18px] bg-white rounded-full shadow-sm">
        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" viewBox="0 0 24 24" class="w-3 h-3" data-v-5fe10632="">
