<template>
  <div class="flex flex-col justify-center items-center mb-8 text-[#3c3c4354]">
  ...
  <p class="mt-2.5 max-w-xs text-center text-base text-[#3c3c43b3]">Vite is free and open source, made possible by wonderful sponsors.</p>
  </div>
</template>
